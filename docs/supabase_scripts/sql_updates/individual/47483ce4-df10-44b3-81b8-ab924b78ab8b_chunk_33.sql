-- Update content for 'Ball of Fat' (Chunk 33/33)
BEGIN;
-- Append next chunk
UPDATE stories SET original_text = original_text || 't violently and he gave a scream,
...
“I am going to look at a drowned man whom they fished up near the
      ...
      his trousers in order to tie his legs together with them.”' WHERE id = '47483ce4-df10-44b3-81b8-ab924b78ab8b';
COMMIT;