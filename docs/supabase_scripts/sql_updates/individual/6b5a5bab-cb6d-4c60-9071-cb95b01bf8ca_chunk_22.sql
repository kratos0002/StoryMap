-- Update content for 'The Necklace' (Chunk 22/33)
BEGIN;
-- Append next chunk
UPDATE stories SET original_text = original_text || 'd of my fist, and crash! crash! One on the
...
Then, trembling with fury, she threw herself on the paralytic, showering
      ...
      spluttering and shouting, an' WHERE id = '6b5a5bab-cb6d-4c60-9071-cb95b01bf8ca';
COMMIT;