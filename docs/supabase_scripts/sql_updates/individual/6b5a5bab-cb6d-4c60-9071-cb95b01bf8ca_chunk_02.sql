-- Update content for 'The Necklace' (Chunk 2/33)
BEGIN;
-- Append next chunk
UPDATE stories SET original_text = original_text || '    not in the least coarse. The ladies, in particular, were adepts at
...
From time to time Luc would mention a name, or allude to some boyish prank
      w' WHERE id = '6b5a5bab-cb6d-4c60-9071-cb95b01bf8ca';
COMMIT;