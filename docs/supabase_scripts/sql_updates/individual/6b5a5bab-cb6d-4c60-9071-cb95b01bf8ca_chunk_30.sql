-- Update content for 'The Necklace' (Chunk 30/33)
BEGIN;
-- Append next chunk
UPDATE stories SET original_text = original_text || 'fectly still. She put her
...
Two hours later I was climbing the edge of the deep funnel that incloses
      ...
      depart' WHERE id = '6b5a5bab-cb6d-4c60-9071-cb95b01bf8ca';
COMMIT;