-- Update content for 'Rashomon' (Chunk 4/5)
BEGIN;
-- Append next chunk
UPDATE stories SET original_text = original_text || ' known what the temper of
...
“This was not a very dignified situation for our venerable chair,”
      ...
      reading the newspaper, or ' WHERE id = 'cc6b25c3-51f9-4ae7-87ed-800191fdcd0d';
COMMIT;