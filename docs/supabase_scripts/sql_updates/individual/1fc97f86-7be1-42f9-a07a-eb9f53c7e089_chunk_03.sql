-- Update content for 'The Arabian Nights (Selected Tales)' (Chunk 3/8)
BEGIN;
-- Append next chunk
UPDATE stories SET original_text = original_text || 'imbed up at last, and
...
their minds a way of escape, but could not find any that seemed good' WHERE id = '1fc97f86-7be1-42f9-a07a-eb9f53c7e089';
COMMIT;