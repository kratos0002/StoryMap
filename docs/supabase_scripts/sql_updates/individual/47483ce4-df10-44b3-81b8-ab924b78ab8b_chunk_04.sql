-- Update content for 'Ball of Fat' (Chunk 4/33)
BEGIN;
-- Append next chunk
UPDATE stories SET original_text = original_text || 'hot. That was his way of protesting against the invasion, a
...
It was during the war, when I was living with my father. I was a young
      ...
      evening a German colonel came and took up his abode in our house. He lef' WHERE id = '47483ce4-df10-44b3-81b8-ab924b78ab8b';
COMMIT;