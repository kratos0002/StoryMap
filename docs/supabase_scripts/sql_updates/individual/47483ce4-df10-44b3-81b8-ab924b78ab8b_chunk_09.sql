-- Update content for 'Ball of Fat' (Chunk 9/33)
BEGIN;
-- Append next chunk
UPDATE stories SET original_text = original_text || 'bound like a rabbit, and then I reflected that a woman
...
At the watering-places the vulgarity is unrestrained. I must here make one
      admission—that my indignation is perhaps due to the fact that I am
...
The other day I was present at a musical evening at the Casino, given by a
      ...
      two charming vaudeville performers, M——and Meillet. I met, on
...
Many of the things you have said to me are very sensible, but that does
      ...
      them myself, I perceived this much—that if men are not always
...
It is we, you see, who should be taught politeness, and the task would be
      ...
      speak to me about Etretat and about the people who indulged in “tittle-tattle”
...
Rose did not go to bed that night. She threw herself, dressed as she was,
      ...
      felt a mad inclination t' WHERE id = '47483ce4-df10-44b3-81b8-ab924b78ab8b';
COMMIT;