-- Update content for 'Ball of Fat' (Chunk 25/33)
BEGIN;
-- Append next chunk
UPDATE stories SET original_text = original_text || ' I perceived the great viaduct of Point du Jour which
...
“Go into one of their huts; you will never find the father there. I' WHERE id = '47483ce4-df10-44b3-81b8-ab924b78ab8b';
COMMIT;