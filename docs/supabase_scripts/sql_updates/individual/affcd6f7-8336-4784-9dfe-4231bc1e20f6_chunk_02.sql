-- Update content for 'In a Grove' (Chunk 2/5)
BEGIN;
-- Append next chunk
UPDATE stories SET original_text = original_text || 'about them. I
...
“So, my dear Clara,” said Grandfather, “after our chair had entered the
      ...
      waited o' WHERE id = 'affcd6f7-8336-4784-9dfe-4231bc1e20f6';
COMMIT;