-- Update content for 'Ball of Fat' (Chunk 6/33)
BEGIN;
-- Append next chunk
UPDATE stories SET original_text = original_text || 'commenced.
...
“I washed her disfigured face. Under the touch of my finger an eye
      was slightly opened and regarded me with that ' WHERE id = '47483ce4-df10-44b3-81b8-ab924b78ab8b';
COMMIT;