-- Update content for 'The Necklace' (Chunk 24/33)
BEGIN;
-- Append next chunk
UPDATE stories SET original_text = original_text || '  decomposed, leaving only her bones lying in the silk robe which she has
...
It came up to the wharf and I went on board. People were there already in
      ...
      us. And suddenly' WHERE id = '6b5a5bab-cb6d-4c60-9071-cb95b01bf8ca';
COMMIT;