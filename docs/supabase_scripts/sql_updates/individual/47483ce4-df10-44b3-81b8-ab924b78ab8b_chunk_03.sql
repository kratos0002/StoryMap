-- Update content for 'Ball of Fat' (Chunk 3/33)
BEGIN;
-- Append next chunk
UPDATE stories SET original_text = original_text || 'hich would give them food for plenty of thought. And the home country, so
...
The bells had not rung since their arrival. That was the only resistance
      ...
      himself to be s' WHERE id = '47483ce4-df10-44b3-81b8-ab924b78ab8b';
COMMIT;