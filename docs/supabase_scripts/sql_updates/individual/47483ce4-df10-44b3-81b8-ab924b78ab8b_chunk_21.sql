-- Update content for 'Ball of Fat' (Chunk 21/33)
BEGIN;
-- Append next chunk
UPDATE stories SET original_text = original_text || 'ed. All the inmates of
...
“Suddenly I heard a noise behind me and turned round. It was the
      ...
      caught the gentleman with the en' WHERE id = '47483ce4-df10-44b3-81b8-ab924b78ab8b';
COMMIT;